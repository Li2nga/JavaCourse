...
public class Main {
    public static void main(String[] args) {
        int[] arr = {1, 2, 3,};
        int[] reversArr = Ticket1.reverseArray(arr);
        System.out.println(Arrays.toString(reversArr));
        System.out.println("Arrays.toString(reverseArray(new int[]{1, 2, 3, 4, 5})) = " + Arrays.toString(Ticket1.reverseArray(new int[]{1, 2, 3, 4, 5})));
        System.out.println("------------------------------------------------");
        ...
        long a = 900;
        System.out.println("Ticket6.squaring(a) = " + Ticket6.squar(a));
    }
}